...
<div class="container content" style="">
	<div class="row"> 
		...
		<div class="mt-2  col-sm-12 col-md-8 offset-2">
				  ...
				  <form method="POST"  class="mt-3" action="/meeting/store">
                        @csrf
                        ...
                        <div class="row mb-2">
                            ...
                            <div class="col-md-12">
                                <input id="time" type="time" class="form-control @error('time') is-invalid @enderror" name="time" required autocomplete="current-time">
                        ...
                        <div class="row mb-2">
                            ...
                            <div class="col-md-12">
                                <input id="url" type="text" class="form-control @error('url') is-invalid @enderror" name="url" required autocomplete="current-url">
